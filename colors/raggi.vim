...
hi Normal                 term=NONE            cterm=NONE             ctermbg=255           ctermfg=16   gui=NONE            guibg=#f9f9f9  guifg=#000000
...
hi LineNr                 term=underline       cterm=NONE             ctermbg=bg            ctermfg=59   gui=NONE            guibg=bg       guifg=#bbbbbb
...
hi SpecialComment         term=NONE            cterm=bold             ctermbg=bg            ctermfg=59   gui=bold,italic     guibg=bg       guifg=#999999
...
hi VertSplit              term=reverse         cterm=reverse          ctermbg=145           ctermfg=59   gui=reverse         guibg=#eaeaea  guifg=#666666
...
hi Comment                term=bold            cterm=NONE             ctermbg=bg            ctermfg=59   gui=italic          guibg=bg       guifg=#999988
